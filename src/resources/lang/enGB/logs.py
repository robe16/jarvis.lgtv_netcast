...
logDescDeviceCursorvisibility = 'Change cursor visibility'
logDescDeviceTouchmove = 'Touch move'
logDescDeviceTouchclick = 'Touch click'
logDescDeviceTouchwheel = 'Touch wheel'
