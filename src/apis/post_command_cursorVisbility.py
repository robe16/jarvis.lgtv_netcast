...
from validation.validation import validate_cursorVisbility


def post_command_cursorVisbility(request, _tvlgnetcast):
    #
    ...
    try:
        ...
        if validate_cursorVisbility(data_dict):
            ...
            r = _tvlgnetcast.sendcursorVisbility(visbility)
            #
            if not bool(r):
